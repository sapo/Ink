...
$.fn.displayBox = function(css, fn, isFlash) {
    ...
    $.blockUI.impl.install(window, msg, { width: w, height: h, marginTop: mt, marginLeft: ml, top: '80px' }, opts);
};
...
$.blockUI.impl = {
    ...
    install: function(el, msg, css, opts) {
        ...
        var w = $('<div class="blockUI displayBox_overlay" style="z-index:1001;cursor:wait;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0;filter:progid:DXImageTransform.Microsoft.Alpha(50)"></div>');
