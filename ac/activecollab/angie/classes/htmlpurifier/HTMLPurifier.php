...
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/ConfigSchema.php'; // fatal errors if not included
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/Config.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/Context.php';

require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/Lexer.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/Generator.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/Strategy/Core.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/Encoder.php';

require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/ErrorCollector.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/LanguageFactory.php';
