...
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/TagTransform/Simple.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/TagTransform/Font.php';

require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/AttrTransform/BgColor.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/AttrTransform/BoolToCSS.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/AttrTransform/Border.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/AttrTransform/Name.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/AttrTransform/Length.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/AttrTransform/ImgSpace.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/AttrTransform/EnumToCSS.php';

require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/ChildDef/StrictBlockquote.php';
