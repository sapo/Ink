...
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/Token.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/Encoder.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/EntityParser.php';

// implementations
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/Lexer/DirectLex.php';
if (version_compare(PHP_VERSION, "5", ">=")) {
    ...
    require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/Lexer/DOMLex.php';
}
