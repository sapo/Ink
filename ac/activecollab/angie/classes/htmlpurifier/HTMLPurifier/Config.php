...
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/ConfigSchema.php';

// member variables
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/HTMLDefinition.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/CSSDefinition.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/URIDefinition.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/Doctype.php';
require_once HTML_PURIFIER_LIB_PATH . '/HTMLPurifier/DefinitionCacheFactory.php';
