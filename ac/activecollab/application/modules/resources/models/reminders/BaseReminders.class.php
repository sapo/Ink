<?php
   ...
   * BaseReminders class
   */
  class BaseReminders extends DataManager {
    ...
    function find($arguments = null) {
      return DataManager::find($arguments, TABLE_PREFIX . 'reminders', 'Reminder');
    } // find
    ...
    function findById($id) {
      return DataManager::findById($id, TABLE_PREFIX . 'reminders', 'Reminder');
    } // findById
    ...
    function count($conditions = null) {
      return DataManager::count($conditions, TABLE_PREFIX . 'reminders');
    } // count
    ...
    function update($updates, $conditions = null) {
      return DataManager::update($updates, $conditions, TABLE_PREFIX . 'reminders');
    } // update
    ...
    function delete($conditions = null) {
      return DataManager::delete($conditions, TABLE_PREFIX . 'reminders');
    } // delete
