<?php
  ...
  /**
   * BaseSubscriptions class
   */
  class BaseSubscriptions extends DataManager {
    ...
    function find($arguments = null) {
      return DataManager::find($arguments, TABLE_PREFIX . 'subscriptions', 'Subscription');
    } // find
    ...
    function findById($id) {
      return DataManager::findById($id, TABLE_PREFIX . 'subscriptions', 'Subscription');
    } // findById
    ...
    function count($conditions = null) {
      return DataManager::count($conditions, TABLE_PREFIX . 'subscriptions');
    } // count
    ...
    function update($updates, $conditions = null) {
      return DataManager::update($updates, $conditions, TABLE_PREFIX . 'subscriptions');
    } // update
    ...
    function delete($conditions = null) {
      return DataManager::delete($conditions, TABLE_PREFIX . 'subscriptions');
    } // delete
    ...
    function paginate($arguments = null, $page = 1, $per_page = 10) {
      return DataManager::paginate($arguments, $page, $per_page, TABLE_PREFIX . 'subscriptions', 'Subscription');
    } // paginate
