<?php
   ...
   * BaseDocuments class
   */
  class BaseDocuments extends DataManager {
    ...
    function findBySQL($sql, $arguments = null, $one = false) {
      return DataManager::findBySQL($sql, $arguments, $one, TABLE_PREFIX . 'documents', 'Document');
    } // findBySQL
    ...
    function count($conditions = null) {
      return DataManager::count($conditions, TABLE_PREFIX . 'documents');
    } // count
    ...
    function update($updates, $conditions = null) {
      return DataManager::update($updates, $conditions, TABLE_PREFIX . 'documents');
    } // update
    ...
    function delete($conditions = null) {
      return DataManager::delete($conditions, TABLE_PREFIX . 'documents');
    } // delete
    ...
    function paginate($arguments = null, $page = 1, $per_page = 10) {
      return DataManager::paginate($arguments, $page, $per_page, TABLE_PREFIX . 'documents', 'Document');
    } // paginate
