<?php
   ...
   */
  class BaseCurrencies extends DataManager {
    ...
    function find($arguments = null) {
      return DataManager::find($arguments, TABLE_PREFIX . 'currencies', 'Currency');
    } // find
    ...
    function findById($id) {
      return DataManager::findById($id, TABLE_PREFIX . 'currencies', 'Currency');
    } // findById
    ...
    function count($conditions = null) {
      return DataManager::count($conditions, TABLE_PREFIX . 'currencies');
    } // count
    ...
    function update($updates, $conditions = null) {
      return DataManager::update($updates, $conditions, TABLE_PREFIX . 'currencies');
    } // update
    ...
    function delete($conditions = null) {
      return DataManager::delete($conditions, TABLE_PREFIX . 'currencies');
    } // delete
