<?php
  ...
  /**
   * BaseIncomingMails class
   */
  class BaseIncomingMails extends DataManager {
    ...
    function find($arguments = null) {
      return DataManager::find($arguments, TABLE_PREFIX . 'incoming_mails', 'IncomingMail');
    } // find
    ...
    function findBySQL($sql, $arguments = null, $one = false) {
      return DataManager::findBySQL($sql, $arguments, $one, TABLE_PREFIX . 'incoming_mails', 'IncomingMail');
    } // findBySQL
    ...
    function findById($id) {
      return DataManager::findById($id, TABLE_PREFIX . 'incoming_mails', 'IncomingMail');
    } // findById
    ...
    function count($conditions = null) {
      return DataManager::count($conditions, TABLE_PREFIX . 'incoming_mails');
    } // count
    ...
    function update($updates, $conditions = null) {
      return DataManager::update($updates, $conditions, TABLE_PREFIX . 'incoming_mails');
    } // update
    ...
    function delete($conditions = null) {
      return DataManager::delete($conditions, TABLE_PREFIX . 'incoming_mails');
    } // delete
    ...
    function paginate($arguments = null, $page = 1, $per_page = 10) {
      return DataManager::paginate($arguments, $page, $per_page, TABLE_PREFIX . 'incoming_mails', 'IncomingMail');
    } // paginate
