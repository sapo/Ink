<?php
  ...
  /**
   * BaseIncomingMailActivityLogs class
   */
  class BaseIncomingMailActivityLogs extends DataManager {
    ...
    function find($arguments = null) {
      return DataManager::find($arguments, TABLE_PREFIX . 'incoming_mail_activity_logs', 'IncomingMailActivityLog');
    } // find
    ...
    function findById($id) {
      return DataManager::findById($id, TABLE_PREFIX . 'incoming_mail_activity_logs', 'IncomingMailActivityLog');
    } // findById
    ...
    function count($conditions = null) {
      return DataManager::count($conditions, TABLE_PREFIX . 'incoming_mail_activity_logs');
    } // count
    ...
    function update($updates, $conditions = null) {
      return DataManager::update($updates, $conditions, TABLE_PREFIX . 'incoming_mail_activity_logs');
    } // update
    ...
    function delete($conditions = null) {
      return DataManager::delete($conditions, TABLE_PREFIX . 'incoming_mail_activity_logs');
    } // delete
    ...
    function paginate($arguments = null, $page = 1, $per_page = 10) {
      return DataManager::paginate($arguments, $page, $per_page, TABLE_PREFIX . 'incoming_mail_activity_logs', 'IncomingMailActivityLog');
    } // paginate
