<?php
  ...
  /**
   * BaseIncomingMailAttachments class
   */
  class BaseIncomingMailAttachments extends DataManager {
    ...
    function findBySQL($sql, $arguments = null, $one = false) {
      return DataManager::findBySQL($sql, $arguments, $one, TABLE_PREFIX . 'incoming_mail_attachments', 'IncomingMailAttachment');
    } // findBySQL
    ...
    function count($conditions = null) {
      return DataManager::count($conditions, TABLE_PREFIX . 'incoming_mail_attachments');
    } // count
    ...
    function update($updates, $conditions = null) {
      return DataManager::update($updates, $conditions, TABLE_PREFIX . 'incoming_mail_attachments');
    } // update
    ...
    function delete($conditions = null) {
      return DataManager::delete($conditions, TABLE_PREFIX . 'incoming_mail_attachments');
    } // delete
    ...
    function paginate($arguments = null, $page = 1, $per_page = 10) {
      return DataManager::paginate($arguments, $page, $per_page, TABLE_PREFIX . 'incoming_mail_attachments', 'IncomingMailAttachment');
    } // paginate
