<?php
  ...
  /**
   * BaseProjectGroups class
   */
  class BaseProjectGroups extends DataManager {
    ...
    function find($arguments = null) {
      return DataManager::find($arguments, TABLE_PREFIX . 'project_groups', 'ProjectGroup');
    } // find
    ...
    function findById($id) {
      return DataManager::findById($id, TABLE_PREFIX . 'project_groups', 'ProjectGroup');
    } // findById
    ...
    function count($conditions = null) {
      return DataManager::count($conditions, TABLE_PREFIX . 'project_groups');
    } // count
    ...
    function delete($conditions = null) {
      return DataManager::delete($conditions, TABLE_PREFIX . 'project_groups');
    } // delete
