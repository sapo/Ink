...
<div class="day_activities">
  ...
  <div class="{cycle values=''} activity {$activity_object->getType()|lower}_activity {$activity->getType()|lower}_activity">
    ...
    <div class="log_time"><span>{object_star object=$activity_object user=$logged_user}</span> &middot; {project_link project=$activity_object->getProject()} &middot; <strong>{$activity->getCreatedOn()|datetime}</strong></div>
    <div class="log_info">
