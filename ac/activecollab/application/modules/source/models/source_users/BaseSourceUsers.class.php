<?php
  ...
  /**
   * BaseSourceUsers class
   */
  class BaseSourceUsers extends DataManager {
    ...
    function find($arguments = null) {
      return DataManager::find($arguments, TABLE_PREFIX . 'source_users', 'SourceUser');
    } // find
    ...
    function count($conditions = null) {
      return DataManager::count($conditions, TABLE_PREFIX . 'source_users');
    } // count
