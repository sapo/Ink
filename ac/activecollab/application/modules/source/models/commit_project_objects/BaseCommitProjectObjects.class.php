<?php
  ...
  /**
   * BaseCommitProjectObjects class
   */
  class BaseCommitProjectObjects extends DataManager {
    ...
    function find($arguments = null) {
      return DataManager::find($arguments, TABLE_PREFIX . 'commit_project_objects', 'CommitProjectObject');
    } // find
    ...
    function findById($id) {
      return DataManager::findById($id, TABLE_PREFIX . 'commit_project_objects', 'CommitProjectObject');
    } // findById
    ...
    function count($conditions = null) {
      return DataManager::count($conditions, TABLE_PREFIX . 'commit_project_objects');
    } // count
    ...
    function delete($conditions = null) {
      return DataManager::delete($conditions, TABLE_PREFIX . 'commit_project_objects');
    } // delete
    ...
    function paginate($arguments = null, $page = 1, $per_page = 10) {
      return DataManager::paginate($arguments, $page, $per_page, TABLE_PREFIX . 'commit_project_objects', 'CommitProjectObject');
    } // paginate
