...
Ink
        .createModule(
                ...
                function(ko) {
                    /*
                     * knockout.simpleGrid1.3.js | (c) 2013 Ryan Niemeyer |
                     * http://www.opensource.org/licenses/mit-license
                     * 
                     * With changes from SAPO's Intra team (eg. better
                     * pagination, sort header icon)
                     */
                    (function() {
                        // Private function
                        ...
                        ko.simpleGrid = {
                            // Defines a view model class you can use to
                            // populate a grid
                            viewModel : function(configuration) {
                                ...
                                // INTRA: Wrap the sort handler to introduce the
                        ...
                        ko.bindingHandlers.simpleGrid = {
                            ...
                            update : function(element, viewModelAccessor, allBindingsAccessor) {
                                ...
                                var gridTemplateName = allBindings.simpleGridTemplate || 
                                    "Ink.Data.Grid.InkGridTemplate", pageLinksTemplateName = allBindings.simpleGridPagerTemplate || 
                                    "Ink.Data.Grid.InkPagerTemplate";
