			...
			<fieldset class="box space">
				...
				<div class="e_wrap">
					...
					<ul class="formList">
						...
						<li><label for="checkbox2"><input id="checkbox2" type="checkbox">Checkbox Label</label></li>
						<li><label for="checkbox3"><input id="checkbox3" type="checkbox">Checkbox Label</label></li>
					</ul>
				</div>
