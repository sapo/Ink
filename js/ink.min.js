...
(function(){"use strict";if(!("Ink"in window)){var e={Ink:"INK_PATH"in window?window.INK_PATH:window.location.protocol+"//js.ink.sapo.pt/Ink/"},n={},r=[],t={},o=[],i=function(e){if("object"!=typeof e)return!1;for(var n in e)return!1;return!0};window.Ink={_checkPendingRequireModules:function(){var e,r,t,i,u,c,a=[];for(e=0,r=o.length;r>e;++e)if(t=o[e]){for(i in t.left)u=n[i],u&&(t.args[t.left[i]]=u,delete t.left[i],--t.remaining);if(t.remaining>0)a.push(t);else{if(c=t.cb,!c)continue;delete t.cb,c.apply(!1,t.args)}}o=a,o.length>0&&setTimeout(function(){Ink._checkPendingRequireModules()},0)},_modNameToUri:function(n){if(-1!==n.indexOf("/"))return n;var r=n.replace(/_/g,".").split("."),t=r.shift(),o=e[t];return o||(o="./"+t+"/"),[o,r.join("/"),"/lib.js"].join("")},getPath:function(n){return e[n||"Ink"]},setPath:function(n,r){e[n]=r},loadScript:function(e){var n=document.createElement("script");n.setAttribute("type","text/javascript"),n.setAttribute("src",this._modNameToUri(e));var r=document.getElementsByTagName("head");r.length>0&&r[0].appendChild(n)},namespace:function(e,n){if(!e||!e.length)return null;for(var r,t=e.split("."),o=window,i=0,u=t.length;u>i;++i)o[t[i]]=o[t[i]]||{},r=o,o=o[t[i]];return n?[r,t[i-1]]:o},getModule:function(e,r){var t=r?[e,"_",r].join(""):e;return n[t]},createModule:function(e,o,u,c){var a=function(){if(!("number"==typeof o||"string"==typeof o&&o.length>0))throw Error("version must be passed!");var u=[e,"_",o].join("");if(!n[u]){delete t[u],delete t[e];var a=Array.prototype.slice.call(arguments),l=c.apply(window,a);r.push(u),"object"==typeof l?l._version=o:"function"==typeof l&&(l.prototype._version=o,l._version=o);var s,f=0===e.indexOf("Ink.");f&&(s=Ink.namespace(e,!0)),n[u]=l,f&&(s[0][s[1]+"_"+o]=l),n[e]=l,f&&i(s[0][s[1]])&&(s[0][s[1]]=l),this&&Ink._checkPendingRequireModules()}};this.requireModules(u,a)},requireModules:function(e,r){var i,u,c,a,l;for(u=e.length,c={args:Array(u),left:{},remaining:u,cb:r},i=0;u>i;++i)a=e[i],l=n[a],l?(c.args[i]=l,--c.remaining):(t[a]||(t[a]=!0,Ink.loadScript(a)),c.left[a]=i);c.remaining>0?o.push(c):r.apply(!0,c.args)},getModulesLoadOrder:function(){return r.slice()},getModuleScripts:function(){var e=this.getModulesLoadOrder();return e.unshift("Ink_1"),e=e.map(function(e){var n=e.indexOf(".");-1===n&&(n=e.indexOf("_"));var r=e.substring(0,n);e=e.substring(n+1);var t=Ink.getPath(r);return['<script type="text/javascript" src="',t,e.replace(/\./g,"/"),'/"></script>'].join("")}),e.join("\n")},bind:function(e,n){var r=Array.prototype.slice.call(arguments,2);return function(){var t=Array.prototype.slice.call(arguments),o=r.concat(t);return e.apply(n,o)}},bindEvent:function(e,n){var r=Array.prototype.slice.call(arguments,2);return function(t){var o=r.slice();return o.unshift(t||window.event),e.apply(n,o)}},i:function(e){if(!e)throw Error("Ink.i => id or element must be passed");return"string"==typeof e?document.getElementById(e):e},s:function(e,n){if(Ink.Dom===void 0||Ink.Dom.Selector===void 0)throw Error("This method requires Ink.Dom.Selector");if(document.querySelector)return(n||document).querySelector(e);var r=Ink.Dom.Selector.select(e,n||document);return r.length>0?r[0]:null},ss:function(e,n){if(Ink.Dom===void 0||Ink.Dom.Selector===void 0)throw Error("This method requires Ink.Dom.Selector");if(document.querySelectorAll){var r=(n||document).querySelectorAll(e);return Array.prototype.slice.call(r)}return Ink.Dom.Selector.select(e,n||document)},extendObj:function(e,n){if(n)for(var r in n)n.hasOwnProperty(r)&&(e[r]=n[r]);return e}}}})();
...
Ink.createModule("Ink.Util.I18n","1",[],function(){"use strict";function e(e,t,n){this._init(e,t,n)}function t(e,t){var n={};return n[e]=t,n}return e.prototype={_init:function(e,t,n){this._testMode=!1,this._lang=t||"pt_PT",this._strings={},this._otherDicts=[],this.append(e||{},n)},append:function(e,n){n&&(e=t(this._lang,e)),this._otherDicts.push(e),Ink.extendObj(this._strings,e[this._lang])},getLang:function(){return this._lang},setLang:function(e){if(this._lang!==e){this._lang=e,this._strings={};for(var t=0,n=this._otherDicts.length;n>t;t++)Ink.extendObj(this._strings,this._otherDicts[t][e]||{})}},testMode:function(e){this._testMode=e||!1},alias:function(){var t=Ink.bind(e.prototype.text,this);return t.ntext=Ink.bind(e.prototype.ntext,this),t.append=Ink.bind(e.prototype.append,this),t.ordinal=Ink.bind(e.prototype.ordinal,this),t.testMode=Ink.bind(e.prototype.testMode,this),t},text:function(e){if("string"==typeof e){var t,n;this._strings?(n=this._strings[e],t=n===void 0?this._testMode?"["+e+"]":e:n):t=e;var r,o=!1,i=arguments.length;if(i>1)for(r=1;i>r;++r)arguments[r]!==void 0&&(o=RegExp("{%s:"+r+"}",""),t=o.test(t)?t.replace(o,arguments[r]):t.replace(/\{%s\}/,arguments[r]),o=null,o=!1);return t=t.replace(/\{%s(\:\d*)?\}/gi,"")}},ntext:function(e,t,n){var r=[].slice.call(arguments,2);return 1===n?this.text.apply(this,[e].concat(r)):this.text.apply(this,[t].concat(r))},ordinal:function(e,t){function n(t,n){if(n=n===void 0?e:n,void 0!==t)if("function"==typeof t)try{var r=t(n);return"string"==typeof r?r:null}catch(o){}else{if("object"==typeof t)return t[n];if("string"==typeof t)return t}}function r(t){return n(t.exceptions,e)||n(t.byLastDigit,+o[o.length-1])||n(t.default,e)||null}if(e===void 0)return"";var o=""+e;t=t||{};var i=this._strings._ordinals||{},s=n(t,e)||n(i,e);return s?s:r(t)||r(i)||""}},e});
