...
!function(e,n){"use strict";if(!("Ink"in e)){var t={},r="INK_STATICMODE"in e?e.INK_STATICMODE:!1,i={},o=[],l={},u=[],a=function(e){if("object"!=typeof e)return!1;for(var n in e)if(e.hasOwnProperty(n))return!1;return!0};e.Ink={_checkPendingRequireModules:function(){var e,n,t,r,o,l,a=[];for(e=0,n=u.length;n>e;++e)if(t=u[e]){for(r in t.left)t.left.hasOwnProperty(r)&&(o=i[r],o&&(t.args[t.left[r]]=o,delete t.left[r],--t.remaining));if(t.remaining>0)a.push(t);else{if(l=t.cb,!l)continue;delete t.cb,l.apply(!1,t.args)}}u=a,u.length>0&&setTimeout(function(){Ink._checkPendingRequireModules()},0)},setStaticMode:function(e){r=e},getPath:function(e,n){var r,i,o,l,u=e.split(/[._]/g);for(i=u.length;i>=0;i-=1)if(r=u.slice(0,i+1).join("."),t[r]){o=r;break}return l=t[o||"Ink"],"/"!==l[l.length-1]&&(l+="/"),i<u.length&&(l+=u.slice(i+1).join("/")+"/"),n||(l+="lib.js"),l},setPath:function(e,n){t[e.replace(/_/,".")]=n},loadScript:function(e){if(r)throw new Error("Requiring a module to be loaded dynamically while in static mode");-1===e.indexOf("/")&&(e=this.getPath(e));var t=n.createElement("script");t.setAttribute("type","text/javascript"),t.setAttribute("src",e);var i=n.getElementsByTagName("head");i.length>0&&i[0].appendChild(t)},namespace:function(n,t){if(!n||!n.length)return null;for(var r,i=n.split("."),o=e,l=0,u=i.length;u>l;++l)o[i[l]]=o[i[l]]||{},r=o,o=o[i[l]];return t?[r,i[l-1]]:o},getModule:function(e,n){var t=n?[e,"_",n].join(""):e;return i[t]},createModule:function(n,t,r,u){if("string"!=typeof n)throw new Error("module name must be a string!");if(!("number"==typeof t||"string"==typeof t&&t.length>0))throw new Error("version number missing!");var c=function(){var r=[n,"_",t].join("");if(!i[r]){delete l[r],delete l[n];var c=Array.prototype.slice.call(arguments),s=u.apply(e,c);o.push(r),"object"==typeof s?s._version=t:"function"==typeof s&&(s.prototype._version=t,s._version=t);var f,d=0===n.indexOf("Ink.");d&&(f=Ink.namespace(n,!0)),i[r]=s,d&&(f[0][f[1]+"_"+t]=s),i[n]=s,d&&a(f[0][f[1]])&&(f[0][f[1]]=s),this&&Ink._checkPendingRequireModules()}};this.requireModules(r,c)},requireModules:function(e,n){var t,r,o,a,c;if(r=e.length,o={args:new Array(r),left:{},remaining:r,cb:n},"object"!=typeof e||void 0===e.length)throw new Error("Dependency list should be an array!");if("function"!=typeof n)throw new Error("Callback should be a function!");for(t=0;r>t;++t)a=e[t],c=i[a],c?(o.args[t]=c,--o.remaining):(l[a]||(l[a]=!0,Ink.loadScript(a)),o.left[a]=t);o.remaining>0?u.push(o):n.apply(!0,o.args)},getModulesLoadOrder:function(){return o.slice()},getModuleScripts:function(){var e=this.getModulesLoadOrder();return e.unshift("Ink_1"),e=e.map(function(e){return['<script type="text/javascript" src="',Ink.getModuleURL(e),'"></script>'].join("")}),e.join("\n")},createExt:function(e,n,t,r){return Ink.createModule("Ink.Ext."+e,n,t,r)},deleteModule:function(e){if(!(e in i))throw new Error("Module not found");delete i[e]},bind:function(e,n){var t=Array.prototype.slice.call(arguments,2);return function(){var r=Array.prototype.slice.call(arguments),i=t.concat(r);return e.apply(n,i)}},bindMethod:function(e,n){return this.bind.apply(this,[e[n],e].concat([].slice.call(arguments,2)))},bindEvent:function(n,t){var r=Array.prototype.slice.call(arguments,2);return function(i){var o=r.slice();return o.unshift(i||e.event),n.apply(t,o)}},i:function(e){if(!e)throw new Error("Ink.i => id or element must be passed");return"string"==typeof e?n.getElementById(e):e},s:function(e,t){if("undefined"==typeof Ink.Dom||"undefined"==typeof Ink.Dom.Selector)throw new Error("This method requires Ink.Dom.Selector");return Ink.Dom.Selector.select(e,t||n)[0]||null},ss:function(e,t){if("undefined"==typeof Ink.Dom||"undefined"==typeof Ink.Dom.Selector)throw new Error("This method requires Ink.Dom.Selector");return Ink.Dom.Selector.select(e,t||n)},extendObj:function(e,n){if(arguments.length>2&&(n=Ink.extendObj.apply(this,[].slice.call(arguments,1))),n)for(var t in n)Object.prototype.hasOwnProperty.call(n,t)&&(e[t]=n[t]);return e}},Ink.setPath("Ink","INK_PATH"in e?e.INK_PATH:e.location.protocol+"//js.ink.sapo.pt/Ink/")}}(window,document);
