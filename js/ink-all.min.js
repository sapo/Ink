...
Ink.createModule("Ink.Util.Cookie","1",[],function(){"use strict";var e={get:function(e){var t=document.cookie||!1,n={};if(t){t=t.replace(new RegExp("; ","g"),";");var r=t.split(";"),o=[];if(r.length>0)for(var i=0;i<r.length;i++)o=r[i].split("="),2===o.length&&(n[o[0]]=decodeURIComponent(o[1])),o=[]}return e?"undefined"!=typeof n[e]?n[e]:null:n},set:function(e,t,n,r,o,i){var s;if(!e||t===!1||"undefined"==typeof e||"undefined"==typeof t)return!1;s=e+"="+encodeURIComponent(t);var a=!1,l=!1,u=!1,c=!1;if(n&&"undefined"!=typeof n&&!isNaN(n)){var d=new Date,f=parseInt(Number(d.valueOf()),10)+1e3*Number(parseInt(n,10)),p=new Date(f),h=p.toGMTString(),m=new RegExp("([^\\s]+)(\\s\\d\\d)\\s(\\w\\w\\w)\\s(.*)");h=h.replace(m,"$1$2-$3-$4"),a="expires="+h}else a="undefined"==typeof n||isNaN(n)||0!==Number(parseInt(n,10))?"expires=Thu, 01-Jan-2037 00:00:01 GMT":"";if(l=r&&"undefined"!=typeof r?"path="+r:"path=/",o&&"undefined"!=typeof o)u="domain="+o;else{var g=new RegExp(":(.*)");u="domain="+window.location.host,u=u.replace(g,"")}c=i&&"undefined"!=typeof i?i:!1,document.cookie=s+"; "+a+"; "+l+"; "+u+"; "+c},remove:function(e,t,n){var r=!1,o=!1,i=-999999999;r=t&&"undefined"!=typeof t?t:"/",o=n&&"undefined"!=typeof n?n:window.location.host,this.set(e,"deleted",i,r,o)}};return e});
Ink.createModule("Ink.Util.Date","1",[],function(){"use strict";var e={_months:function(e){var t=["Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"];return t[e]},_iMonth:function(e){return Number(e)?+e-1:{janeiro:0,jan:0,fevereiro:1,fev:1,"março":2,mar:2,abril:3,abr:3,maio:4,mai:4,junho:5,jun:5,julho:6,jul:6,agosto:7,ago:7,setembro:8,set:8,outubro:9,out:9,novembro:10,nov:10,dezembro:11,dez:11}[e.toLowerCase()]},_wDays:function(e){var t=["Domingo","Segunda","Terça","Quarta","Quinta","Sexta","Sábado"];return t[e]},_iWeek:function(e){return Number(e)?+e||7:{segunda:1,seg:1,"terça":2,ter:2,quarta:3,qua:3,quinta:4,qui:4,sexta:5,sex:5,"sábado":6,"sáb":6,domingo:7,dom:7}[e.toLowerCase()]},_daysInMonth:function(e,t){var n;return n=1===e||3===e||5===e||7===e||8===e||10===e||12===e?31:4===e||6===e||9===e||11===e?30:0===t%400||0===t%4&&0!==t%100?29:28},get:function(e,t){("undefined"==typeof e||""===e)&&(e="Y-m-d");var n,r=e.split(""),o=new Array(r.length),i="\\";n="undefined"==typeof t?new Date:"number"==typeof t?new Date(1e3*t):new Date(t);for(var a,s,l,u=0;u<r.length;u++)switch(r[u]){case i:o[u]=r[u+1],u++;break;case"d":var c=n.getDate();o[u]=String(c).length>1?c:"0"+c;break;case"D":o[u]=this._wDays(n.getDay()).substring(0,3);break;case"j":o[u]=n.getDate();break;case"l":o[u]=this._wDays(n.getDay());break;case"N":o[u]=n.getDay()||7;break;case"S":var d=n.getDate(),f=["st","nd","rd"],p="";o[u]=d>=11&&13>=d?"th":(p=f[String(d).substr(-1)-1])?p:"th";break;case"w":o[u]=n.getDay();break;case"z":a=Date.UTC(n.getFullYear(),0,0),s=Date.UTC(n.getFullYear(),n.getMonth(),n.getDate()),o[u]=Math.floor((s-a)/864e5);break;case"W":var h=new Date(n.getFullYear(),0,1);a=h.getDay()||7;var m=Math.floor((n-h)/864e5+1);o[u]=Math.ceil((m-(8-a))/7)+1;break;case"F":o[u]=this._months(n.getMonth());break;case"m":var g=String(n.getMonth()+1);o[u]=g.length>1?g:"0"+g;break;case"M":o[u]=this._months(n.getMonth()).substring(0,3);break;case"n":o[u]=n.getMonth()+1;break;case"t":o[u]=this._daysInMonth(n.getMonth()+1,n.getYear());break;case"L":var y=n.getFullYear();o[u]=y%4?!1:y%100?!0:y%400?!1:!0;break;case"o":throw'"o" not implemented!';case"Y":o[u]=n.getFullYear();break;case"y":o[u]=String(n.getFullYear()).substring(2);break;case"a":o[u]=n.getHours()<12?"am":"pm";break;case"A":o[u]=n.getHours<12?"AM":"PM";break;case"B":throw'"B" not implemented!';case"g":l=n.getHours(),o[u]=12>=l?l:l-12;break;case"G":o[u]=String(n.getHours());break;case"h":l=String(n.getHours()),l=12>=l?l:l-12,o[u]=l.length>1?l:"0"+l;break;case"H":l=String(n.getHours()),o[u]=l.length>1?l:"0"+l;break;case"i":var v=String(n.getMinutes());o[u]=v.length>1?v:"0"+v;break;case"s":var b=String(n.getSeconds());o[u]=b.length>1?b:"0"+b;break;case"u":throw'"u" not implemented!';case"e":throw'"e" not implemented!';case"I":a=new Date(n.getFullYear(),0,1),o[u]=n.getTimezoneOffset()!==a.getTimezoneOffset()?1:0;break;case"O":var w=n.getTimezoneOffset(),E=w%60;l=String(-1*((w-E)/60)),"-"!==l.charAt(0)&&(l="+"+l),l=3===l.length?l:l.replace(/([+\-])(\d)/,"$10$2"),o[u]=l+E+"0";break;case"P":throw'"P" not implemented!';case"T":throw'"T" not implemented!';case"Z":o[u]=60*n.getTimezoneOffset();break;case"c":throw'"c" not implemented!';case"r":var C=this._wDays(n.getDay()).substr(0,3),k=this._months(n.getMonth()).substr(0,3);o[u]=C+", "+n.getDate()+" "+k+this.get(" Y H:i:s O",n);break;case"U":o[u]=Math.floor(n.getTime()/1e3);break;default:o[u]=r[u]}return o.join("")},set:function(e,t){if("undefined"!=typeof t){("undefined"==typeof e||""===e)&&(e="Y-m-d");for(var n,r=e.split(""),o=new Array(r.length),i="\\",a={year:void 0,month:void 0,day:void 0,dayY:void 0,dayW:void 0,week:void 0,hour:void 0,hourD:void 0,min:void 0,sec:void 0,msec:void 0,ampm:void 0,diffM:void 0,diffH:void 0,date:void 0},s=0,l=0;l<r.length;l++)switch(r[l]){case i:o[l]=r[l+1],l++;break;case"d":o[l]="(\\d{2})",a.day={original:l,match:s++};break;case"j":o[l]="(\\d{1,2})",a.day={original:l,match:s++};break;case"D":o[l]="([\\wá]{3})",a.dayW={original:l,match:s++};break;case"l":o[l]="([\\wá]{5,7})",a.dayW={original:l,match:s++};break;case"N":o[l]="(\\d)",a.dayW={original:l,match:s++};break;case"w":o[l]="(\\d)",a.dayW={original:l,match:s++};break;case"S":o[l]="\\w{2}";break;case"z":o[l]="(\\d{1,3})",a.dayY={original:l,match:s++};break;case"W":o[l]="(\\d{1,2})",a.week={original:l,match:s++};break;case"F":o[l]="([\\wç]{4,9})",a.month={original:l,match:s++};break;case"M":o[l]="(\\w{3})",a.month={original:l,match:s++};break;case"m":o[l]="(\\d{2})",a.month={original:l,match:s++};break;case"n":o[l]="(\\d{1,2})",a.month={original:l,match:s++};break;case"t":o[l]="\\d{2}";break;case"L":o[l]="\\w{4,5}";break;case"o":throw'"o" not implemented!';case"Y":o[l]="(\\d{4})",a.year={original:l,match:s++};break;case"y":o[l]="(\\d{2})",("undefined"==typeof a.year||"Y"!==r[a.year.original])&&(a.year={original:l,match:s++});break;case"a":o[l]="(am|pm)",a.ampm={original:l,match:s++};break;case"A":o[l]="(AM|PM)",a.ampm={original:l,match:s++};break;case"B":throw'"B" not implemented!';case"g":o[l]="(\\d{1,2})",a.hourD={original:l,match:s++};break;case"G":o[l]="(\\d{1,2})",a.hour={original:l,match:s++};break;case"h":o[l]="(\\d{2})",a.hourD={original:l,match:s++};break;case"H":o[l]="(\\d{2})",a.hour={original:l,match:s++};break;case"i":o[l]="(\\d{2})",a.min={original:l,match:s++};break;case"s":o[l]="(\\d{2})",a.sec={original:l,match:s++};break;case"u":throw'"u" not implemented!';case"e":throw'"e" not implemented!';case"I":o[l]="\\d";break;case"O":o[l]="([-+]\\d{4})",a.diffH={original:l,match:s++};break;case"P":throw'"P" not implemented!';case"T":throw'"T" not implemented!';case"Z":o[l]="(\\-?\\d{1,5})",a.diffM={original:l,match:s++};break;case"c":throw'"c" not implemented!';case"r":o[l]="([\\wá]{3}, \\d{1,2} \\w{3} \\d{4} \\d{2}:\\d{2}:\\d{2} [+\\-]\\d{4})",a.date={original:l,match:s++};break;case"U":o[l]="(\\d{1,13})",a.date={original:l,match:s++};break;default:o[l]=r[l]}var u=new RegExp(o.join(""));try{if(n=t.match(u),!n)return}catch(c){return}var d,f,p="undefined"!=typeof a.date,h="undefined"!=typeof a.year,m="undefined"!=typeof a.dayY,g="undefined"!=typeof a.day,y="undefined"!=typeof a.month,v=y&&g,b=!y&&g,w="undefined"!=typeof a.dayW,E="undefined"!=typeof a.week,C=E&&w,k=!E&&w,T=m||v||!h&&b||C||!h&&k,x=!(h||m||g||y||w||E),S="undefined"!=typeof a.hourD&&"undefined"!=typeof a.ampm,N="undefined"!=typeof a.hour,I=S||N,D="undefined"!=typeof a.min,A="undefined"!=typeof a.sec,O="undefined"!=typeof a.msec,R=!x||I,M=R||D,L="undefined"!=typeof a.diffM,H="undefined"!=typeof a.diffH;if(p){if("U"===r[a.date.original])return new Date(1e3*+n[a.date.match+1]);var _=n[a.date.match+1].match(/\w{3}, (\d{1,2}) (\w{3}) (\d{4}) (\d{2}):(\d{2}):(\d{2}) ([+\-]\d{4})/);return d=+_[4]+ +_[7].slice(0,3),f=+_[5]+60*((_[7].slice(0,1)+_[7].slice(3))/100),new Date(_[3],this._iMonth(_[2]),_[1],d,f,_[6])}var P,B,j,q,F,W,$,U=new Date;if(T||x){if(T){if(h){var Y=U.getFullYear()-50+"";P=n[a.year.match+1],"y"===r[a.year.original]&&(P=+Y.slice(0,2)+(P>=Y.slice(2)?0:1)+P)}else P=U.getFullYear();if(m)B=0,j=n[a.dayY.match+1];else if(g)B=y?this._iMonth(n[a.month.match+1]):U.getMonth(),j=n[a.day.match+1];else{B=0;var X;X=E?n[a.week.match+1]:this.get("W",U),j=7*(X-2)+(8-(new Date(P,0,1).getDay()||7))+this._iWeek(n[a.week.match+1])}if(0===B&&j>31){var z=new Date(P,B,j);B=z.getMonth(),j=z.getDate()}}else P=U.getFullYear(),B=U.getMonth(),j=U.getDate();return q=P+"-"+(B+1)+"-"+j+" ",d=S?+n[a.hourD.match+1]+("pm"===n[a.ampm.match+1]?12:0):N?n[a.hour.match+1]:x?U.getHours():"00",f=D?n[a.min.match+1]:R?"00":U.getMinutes(),F=A?n[a.sec.match+1]:M?"00":U.getSeconds(),W=O?n[a.msec.match+1]:"000",$=H?n[a.diffH.match+1]:L?String(100*(-1*n[a.diffM.match+1]/60)).replace(/^(\d)/,"+$1").replace(/(^[\-+])(\d{3}$)/,"$10$2"):"+0000",new Date(q+d+":"+f+":"+F+"."+W+$)}}}};return e});
