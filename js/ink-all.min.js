...
Ink.createModule("Ink.UI.Toggle","1",["Ink.UI.Common_1","Ink.Dom.Event_1","Ink.Dom.Css_1","Ink.Dom.Element_1","Ink.Dom.Selector_1","Ink.Util.Array_1"],function(e,t,n,i,o,r){"use strict";var s=function(t,n){this._rootElement=e.elOrSelector(t,"[Ink.UI.Toggle]: Failed to find root element"),this._options=Ink.extendObj({target:void 0,triggerEvent:"click",closeOnClick:!0,isAccordion:!1,initialState:null,closeOnInsideClick:"a[href]",onChangeState:null},n||{},i.data(this._rootElement)),this._targets=e.elsOrSelector(this._options.target,"Ink.UI.Toggle target option"),this._init()};return s.prototype={_init:function(){if(this._accordion=n.hasClassName(this._rootElement.parentNode,"accordion")||n.hasClassName(this._targets[0].parentNode,"accordion"),this._firstTime=!0,this._options.triggerEvent&&t.observe(this._rootElement,this._options.triggerEvent,Ink.bindEvent(this._onTriggerEvent,this)),"true"===this._options.closeOnClick.toString()&&t.observe(document,"click",Ink.bindEvent(this._onOutsideClick,this)),this._options.closeOnInsideClick&&t.observeMulti(this._targets,"click",Ink.bindEvent(function(e){i.findUpwardsBySelector(t.element(e),this._options.closeOnInsideClick)&&this.setState(!1,!0)},this)),null!==this._options.initialState)this.setState("true"===this._options.initialState.toString(),!0);else{var e="none"!==n.getStyle(this._targets[0],"display");this.setState(e,!0)}for(var o=0,r=this._targets.length;r>o;o++)this._targets[o].style.display&&(this._targets[o].style.display="")},_onTriggerEvent:function(e){for(var r=t.element(e),s=0,a=this._targets.length;a>s;s++)if(r===this._targets[s]||i.isAncestorOf(this._targets[s],r))return;if(this._accordion){var l,u;for(u=n.hasClassName(this._targets[0].parentNode,"accordion")?this._targets[0].parentNode:this._targets[0].parentNode.parentNode,l=o.select(".toggle",u),s=0;s<l.length;s+=1){var c=i.data(l[s]),d=o.select(c.target,u);d.length>0&&d[0]!==this._targets[0]&&(d[0].style.display="none")}}var h=this.getState();this.setState(!h,!0),!h&&this._firstTime&&(this._firstTime=!1),t.stop(e)},_onOutsideClick:function(e){var n,o=t.element(e),s=r.some(this._targets,function(e){return i.isAncestorOf(e,o)});if(!(this._rootElement===o||i.isAncestorOf(this._rootElement,o)||s||this._firstTime)){if((n=Ink.ss(".ink-shade")).length)for(var a=n.length,l=0;a>l;l++)if(i.isAncestorOf(n[l],o)&&i.isAncestorOf(n[l],this._rootElement))return;this.setState(!1,!0)}},setState:function(e,t){if(t&&"function"==typeof this._options.onChangeState){var i=this._options.onChangeState(!!e);if(i===!1)return!1}for(var o=0,r=this._targets.length;r>o;o++)n.addRemoveClassName(this._targets[o],"show-all",e),n.addRemoveClassName(this._targets[o],"hide-all",!e);n.addRemoveClassName(this._rootElement,"active",e)},getState:function(){return n.hasClassName(this._rootElement,"active")}},s});
