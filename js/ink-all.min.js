...
(function(){"use strict";if(!("Ink"in window)){var e={Ink:"http://js.ink.sapo.pt/Ink/"},t={},r=[],n={},i=[],o=function(e){if("object"!=typeof e)return!1;for(var t in e)return!1;return!0};window.Ink={_checkPendingRequireModules:function(){var e,r,n,o,u,c,a=[];for(e=0,r=i.length;r>e;++e)if(n=i[e]){for(o in n.left)u=t[o],u&&(n.args[n.left[o]]=u,delete n.left[o],--n.remaining);if(n.remaining>0)a.push(n);else{if(c=n.cb,!c)continue;delete n.cb,c.apply(!1,n.args)}}i=a,i.length>0&&setTimeout(function(){Ink._checkPendingRequireModules()},0)},_modNameToUri:function(t){if(-1!==t.indexOf("/"))return t;var r=t.replace(/_/g,".").split("."),n=r.shift(),i=e[n];return i||(i="./"+n+"/"),[i,r.join("/"),"/lib.js"].join("")},getPath:function(t){return e[t||"Ink"]},setPath:function(t,r){e[t]=r},loadScript:function(e){var t=document.createElement("script");t.setAttribute("type","text/javascript"),t.setAttribute("src",this._modNameToUri(e));var r=document.getElementsByTagName("head");r.length>0&&r[0].appendChild(t)},namespace:function(e,t){if(!e||!e.length)return null;for(var r,n=e.split("."),i=window,o=0,u=n.length;u>o;++o)i[n[o]]=i[n[o]]||{},r=i,i=i[n[o]];return t?[r,n[o-1]]:i},getModule:function(e,r){var n=r?[e,"_",r].join(""):e;return t[n]},createModule:function(e,i,u,c){var a=function(){if(!("number"==typeof i||"string"==typeof i&&i.length>0))throw Error("version must be passed!");var u=[e,"_",i].join("");if(!t[u]){delete n[u],delete n[e];var a=Array.prototype.slice.call(arguments),l=c.apply(window,a);r.push(u),"object"==typeof l?l._version=i:"function"==typeof l&&(l.prototype._version=i,l._version=i);var s,f=0===e.indexOf("Ink.");f&&(s=Ink.namespace(e,!0)),t[u]=l,f&&(s[0][s[1]+"_"+i]=l),t[e]=l,f&&o(s[0][s[1]])&&(s[0][s[1]]=l),this&&Ink._checkPendingRequireModules()}};this.requireModules(u,a)},requireModules:function(e,r){var o,u,c,a,l;for(u=e.length,c={args:Array(u),left:{},remaining:u,cb:r},o=0;u>o;++o)a=e[o],l=t[a],l?(c.args[o]=l,--c.remaining):(n[a]||(n[a]=!0,Ink.loadScript(a)),c.left[a]=o);c.remaining>0?i.push(c):r.apply(!0,c.args)},getModulesLoadOrder:function(){return r.slice()},getModuleScripts:function(){var e=this.getModulesLoadOrder();return e.unshift("Ink_1"),e=e.map(function(e){var t=e.indexOf(".");-1===t&&(t=e.indexOf("_"));var r=e.substring(0,t);e=e.substring(t+1);var n=Ink.getPath(r);return['<script type="text/javascript" src="',n,e.replace(/\./g,"/"),'/"></script>'].join("")}),e.join("\n")},bind:function(e,t){var r=Array.prototype.slice.call(arguments,2);return function(){var n=Array.prototype.slice.call(arguments),i=r.concat(n);return e.apply(t,i)}},bindEvent:function(e,t){var r=Array.prototype.slice.call(arguments,2);return function(n){var i=r.slice();return i.unshift(n||window.event),e.apply(t,i)}},i:function(e){if(!e)throw Error("Ink.i => id or element must be passed");return"string"==typeof e?document.getElementById(e):e},s:function(e,t){if(Ink.Dom===void 0||Ink.Dom.Selector===void 0)throw Error("This method requires Ink.Dom.Selector");if(document.querySelector)return(t||document).querySelector(e);var r=Ink.Dom.Selector.select(e,t||document);return r.length>0?r[0]:null},ss:function(e,t){if(Ink.Dom===void 0||Ink.Dom.Selector===void 0)throw Error("This method requires Ink.Dom.Selector");if(document.querySelectorAll){var r=(t||document).querySelectorAll(e);return Array.prototype.slice.call(r)}return Ink.Dom.Selector.select(e,t||document)},extendObj:function(e,t){if(t)for(var r in t)t.hasOwnProperty(r)&&(e[r]=t[r]);return e}}}})();
