...
(function(){"use strict";if(!("Ink"in window)){var e={Ink:"http://js.ink.sapo.pt/Ink/"},r={},t=[],n={},i=[],o=function(e){if("object"!=typeof e)return!1;for(var r in e)return!1;return!0};window.Ink={_checkPendingRequireModules:function(){var e,t,n,o,u,c,a=[];for(e=0,t=i.length;t>e;++e)if(n=i[e]){for(o in n.left)u=r[o],u&&(n.args[n.left[o]]=u,delete n.left[o],--n.remaining);if(n.remaining>0)a.push(n);else{if(c=n.cb,!c)continue;delete n.cb,c.apply(!1,n.args)}}i=a,i.length>0&&setTimeout(function(){Ink._checkPendingRequireModules()},0)},_modNameToUri:function(r){if(-1!==r.indexOf("/"))return r;var t=r.replace(/_/g,".").split("."),n=t.shift(),i=e[n];return i||(i="./"+n+"/"),[i,t.join("/"),"/lib.js"].join("")},getPath:function(r){return e[r||"Ink"]},setPath:function(r,t){e[r]=t},loadScript:function(e){var r=document.createElement("script");r.setAttribute("type","text/javascript"),r.setAttribute("src",this._modNameToUri(e)),document.head.appendChild(r)},namespace:function(e,r){if(!e||!e.length)return null;for(var t,n=e.split("."),i=window,o=0,u=n.length;u>o;++o)i[n[o]]=i[n[o]]||{},t=i,i=i[n[o]];return r?[t,n[o-1]]:i},getModule:function(e,t){var n=t?[e,"_",t].join(""):e;return r[n]},createModule:function(e,i,u,c){var a=function(){if(!("number"==typeof i||"string"==typeof i&&i.length>0))throw Error("version must be passed!");var u=[e,"_",i].join("");if(!r[u]){delete n[u],delete n[e];var a=Array.prototype.slice.call(arguments),s=c.apply(window,a);t.push(u),"object"==typeof s?s._version=i:"function"==typeof s&&(s.prototype._version=i,s._version=i);var l,f=0===e.indexOf("Ink.");f&&(l=Ink.namespace(e,!0)),r[u]=s,f&&(l[0][l[1]+"_"+i]=s),r[e]=s,f&&o(l[0][l[1]])&&(l[0][l[1]]=s),this&&Ink._checkPendingRequireModules()}};this.requireModules(u,a)},requireModules:function(e,t){var o,u,c,a,s;for(u=e.length,c={args:Array(u),left:{},remaining:u,cb:t},o=0;u>o;++o)a=e[o],s=r[a],s?(c.args[o]=s,--c.remaining):(n[a]||(n[a]=!0,Ink.loadScript(a)),c.left[a]=o);c.remaining>0?i.push(c):t.apply(!0,c.args)},getModulesLoadOrder:function(){return t.slice()},getModuleScripts:function(){var e=this.getModulesLoadOrder();return e.unshift("Ink_1"),e=e.map(function(e){var r=e.indexOf(".");-1===r&&(r=e.indexOf("_"));var t=e.substring(0,r);e=e.substring(r+1);var n=Ink.getPath(t);return['<script type="text/javascript" src="',n,e.replace(/\./g,"/"),'/"></script>'].join("")}),e.join("\n")},bind:function(e,r){var t=Array.prototype.slice.call(arguments,2);return function(){var n=Array.prototype.slice.call(arguments),i=t.concat(n);return e.apply(r,i)}},bindEvent:function(e,r){var t=Array.prototype.slice.call(arguments,2);return function(n){var i=t.slice();return i.unshift(n||window.event),e.apply(r,i)}},i:function(e){if(!e)throw Error("Ink.i => id or element must be passed");return"string"==typeof e?document.getElementById(e):e},s:function(e,r){if(Ink.Dom===void 0||Ink.Dom.Selector===void 0)throw Error("This method requires Ink.Dom.Selector");if(document.querySelector)return(r||document).querySelector(e);var t=Ink.Dom.Selector.select(e,r||document);return t.length>0?t[0]:null},ss:function(e,r){if(Ink.Dom===void 0||Ink.Dom.Selector===void 0)throw Error("This method requires Ink.Dom.Selector");if(document.querySelectorAll){var t=(r||document).querySelectorAll(e);return Array.prototype.slice.call(t)}return Ink.Dom.Selector.select(e,r||document)},extendObj:function(e,r){if(r)for(var t in r)r.hasOwnProperty(t)&&(e[t]=r[t]);return e}}}})();
