...
Ink.createModule("Ink.UI.Common","1",["Ink.Dom.Element_1","Ink.Net.Ajax_1","Ink.Dom.Css_1","Ink.Dom.Selector_1","Ink.Util.Url_1"],function(e,t,n,r,i){"use strict";var o={},a=0,s={},u=Object.keys||function(e){var t=[];for(var n in e)e.hasOwnProperty(n)&&t.push(n);return t},l={Layouts:{SMALL:"small",MEDIUM:"medium",LARGE:"large"},isDOMElement:function(e){return"object"==typeof e&&"nodeType"in e&&1===e.nodeType},isInteger:function(e){return"number"==typeof e&&0===e%1},elOrSelector:function(e,t){if(!this.isDOMElement(e)){var n=r.select(e);if(0===n.length)throw new TypeError(t+" must either be a DOM Element or a selector expression!\nThe script element must also be after the DOM Element itself.");return n[0]}return e},elsOrSelector:function(e,t,n){var i;if("string"==typeof e?i=r.select(e):l.isDOMElement(e)?i=[e]:"object"==typeof e&&"number"==typeof e.length&&(i=e),i&&i.length)return i;if(n||2===arguments.length)throw new TypeError(t+" must either be a DOM Element, an Array of elements, or a selector expression!\nThe script element must also be after the DOM Element itself.");return[]},options:function(t,n,r,i){"string"!=typeof t&&(i=r,r=n,n=t,t=""),r=r||{};var o,a,c,d,f,h={},p=i?e.data(i):{},m=function(e){throw t&&(e=t+": "+e),new Error(e)};for(f in n)n.hasOwnProperty(f)&&(a=n[f][0],c=a.toLowerCase(),d=2===n[f].length?n[f][1]:s,a||m("Ink.UI.Common.options: Always specify a type!"),c in l._coerce_funcs||m(""+n[f][0]+" is not a valid type. Use one of "+u(l._coerce_funcs).join(", ")),(!n[f].length||n[f].length>2)&&m('the "defaults" argument must be an object mapping option names to [typestring, optional] arrays.'),o=f in p?l._coerce_from_string(c,p[f]):s,o!==s?(l._options_validate(o,c)||m("Invalid "+c+": "+o),h[f]=o):f in r?h[f]=r[f]:d!==s?h[f]=d:m("Option "+f+" is required!"));return h},_coerce_from_string:function(e,t){return e in l._coerce_funcs?l._coerce_funcs[e](t):t},_options_validate:function(e,t){return l._options_validate_types[t].call(l,e)},_coerce_funcs:function(){var e={element:function(e){return l.elOrSelector(e,"")},elements:function(e){return l.elsOrSelector(e,"",!1)},number:function(e){return+e},"boolean":function(e){return!("false"===e||""===e||null===e)},string:function(e){return e},"function":function(){throw new Error("This parameter is a function. Do not specify it through data-attributes! It's eval!")}};return e.float=e.integer=e.number,e}(),_options_validate_types:function(){var e={string:function(e){return"string"==typeof e},number:function(e){return"number"==typeof e&&!isNaN(e)&&isFinite(e)},integer:function(e){return e===Math.round(e)},element:function(e){return l.isDOMElement(e)},elements:function(e){return"object"==typeof e&&"number"==typeof e.length&&e.length},"boolean":function(e){return"boolean"==typeof e}};return e.float=e.number,e}(),clone:function(e){try{return JSON.parse(JSON.stringify(e))}catch(t){throw new Error("Given object cannot have loops!")}},childIndex:function(e){if(l.isDOMElement(e))for(var t=r.select("> *",e.parentNode),n=0,i=t.length;i>n;++n)if(t[n]===e)return n;throw"not found!"},ajaxJSON:function(e,n,r){new t(e,{evalJS:"force",method:"POST",parameters:n,onSuccess:function(e){try{if(e=e.responseJSON,"ok"!==e.status)throw"server error: "+e.message;r(null,e)}catch(t){r(t)}},onFailure:function(){r("communication failure")}})},currentLayout:function(){var e,t,i,o,a,s=r.select("#ink-layout-detector")[0];if(!s){s=document.createElement("div"),s.id="ink-layout-detector";for(i in this.Layouts)this.Layouts.hasOwnProperty(i)&&(o=this.Layouts[i],a=document.createElement("div"),a.className="show-"+o+" hide-all",a.setAttribute("data-ink-layout",o),s.appendChild(a));document.body.appendChild(s)}for(e=0,t=s.childNodes.length;t>e;++e)if(a=s.childNodes[e],"block"===n.getStyle(a,"display"))return a.getAttribute("data-ink-layout")},hashSet:function(e){if("object"!=typeof e)throw new TypeError("o should be an object!");var t=i.getAnchorString();t=Ink.extendObj(t,e),window.location.hash=i.genQueryString("",t).substring(1)},cleanChildren:function(e){if(!l.isDOMElement(e))throw"Please provide a valid DOMElement";for(var t,n=e.lastChild;n;)t=n.previousSibling,e.removeChild(n),n=t},storeIdAndClasses:function(e,t){if(!l.isDOMElement(e))throw"Please provide a valid DOMElement as first parameter";var n=e.id;n&&(t._id=n);var r=e.className;r&&(t._classes=r)},restoreIdAndClasses:function(e,t){if(!l.isDOMElement(e))throw"Please provide a valid DOMElement as first parameter";t._id&&e.id!==t._id&&(e.id=t._id),t._classes&&-1===e.className.indexOf(t._classes)&&(e.className?e.className+=" "+t._classes:e.className=t._classes),t._instanceId&&!e.getAttribute("data-instance")&&e.setAttribute("data-instance",t._instanceId)},registerInstance:function(e,t,n){if(!e._instanceId){if("object"!=typeof e)throw new TypeError("1st argument must be a JavaScript object!");if(!e._options||!e._options.skipRegister){if(!this.isDOMElement(t))throw new TypeError("2nd argument must be a DOM element!");if(void 0!==n&&"string"!=typeof n)throw new TypeError("3rd argument must be a string!");var r=(n||"instance")+ ++a;o[r]=e,e._instanceId=r;var i=t.getAttribute("data-instance");i=null!==i?[i,r].join(" "):r,t.setAttribute("data-instance",i)}}},unregisterInstance:function(e){delete o[e]},getInstance:function(e){var t;if(this.isDOMElement(e)){if(t=e.getAttribute("data-instance"),null===t)throw new Error("argument is not a DOM instance element!")}else t=e;t=t.split(" ");var n,r,i,a=t.length,s=[];for(i=0;a>i;++i){if(r=t[i],!r)throw new Error("Element is not a JS instance!");if(n=o[r],!n)throw new Error('Instance "'+r+'" not found!');s.push(n)}return 1===a?s[0]:s},getInstanceFromSelector:function(e){var t=r.select(e)[0];if(!t)throw new Error("Element not found!");return this.getInstance(t)},getInstanceIds:function(){var e=[];for(var t in o)o.hasOwnProperty(t)&&e.push(t);return e},getInstances:function(){var e=[];for(var t in o)o.hasOwnProperty(t)&&e.push(o[t]);return e},destroyComponent:function(){Ink.UI.Common.unregisterInstance(this._instanceId),this._element.parentNode.removeChild(this._element)}};return l});
