...
Ink.createModule("Ink.UI.Sticky","1",["Ink.UI.Common_1","Ink.Dom.Event_1","Ink.Dom.Css_1","Ink.Dom.Element_1","Ink.Dom.Selector_1"],function(e,t,n,r){"use strict";var o=function(t,n){if("object"!=typeof t&&"string"!=typeof t)throw"[Sticky] :: Invalid selector defined";this._rootElement=e.elOrSelector(t,"[Sticky] :: Can't find any element with the specified selector"),this._options=Ink.extendObj({offsetBottom:0,offsetTop:0,topElement:null,bottomElement:null},n||{},r.data(this._rootElement)),this._options.topElement&&(this._topElement=e.elOrSelector(this._options.topElement,"Top Element")),this._options.bottomElement&&(this._bottomElement=e.elOrSelector(this._options.bottomElement,"Bottom Element")),this._init()};return o.prototype={_init:function(){t.observe(document,"scroll",Ink.bindEvent(this._onScroll,this)),t.observe(window,"resize",Ink.bindEvent(this._onResize,this))},_onScroll:t.throttle(function(){var e="CSS1Compat"===document.compatMode?document.documentElement:document.body,t=this._rootElement;if(100*r.elementWidth(this._rootElement)/e.clientWidth>90||e.clientWidth<=649)return r.hasAttribute(t,"style")&&t.removeAttribute("style"),void 0;var o=t.getBoundingClientRect(),i=this._topElement&&this._topElement.getBoundingClientRect(),a=this._bottomElement&&this._bottomElement.getBoundingClientRect(),s=this._options.offsetTop?parseInt(this._options.offsetTop,10):0,u=this._options.offsetBottom?parseInt(this._options.offsetBottom,10):0,l=o.bottom-o.top,c=(parseInt(n.getStyle(t,"margin-top"),10)||0)+(parseInt(n.getStyle(t,"margin-bottom"),10)||0),d=this._lastStickingTo;a&&a.top<l+s+u+c?(d="bottom",t.style.position="fixed",t.style.top=a.top-l-u-c+"px"):!i||i.bottom>s?(d="[normal]",t.style.position="static",t.style.top="auto"):i&&i.bottom<=s&&(d="top",t.style.position="fixed",t.style.top=s+"px"),d!==this._lastStickingTo&&(n.addRemoveClassName(t,"ink-sticky-top","top"===d),n.addRemoveClassName(t,"ink-sticky-bottom","bottom"===d))},80),_onResize:t.throttle(function(){this._onScroll()},80)},o});
Ink.createModule("Ink.UI.Table","1",["Ink.Net.Ajax_1","Ink.UI.Common_1","Ink.Dom.Event_1","Ink.Dom.Css_1","Ink.Dom.Element_1","Ink.Dom.Selector_1","Ink.Util.Array_1","Ink.Util.String_1"],function(e,t,n,r,i,o,a,s){"use strict";var l=function(e,n){if(this._rootElement=t.elOrSelector(e,"1st argument"),"table"!==this._rootElement.nodeName.toLowerCase())throw"[Ink.UI.Table] :: The element is not a table";this._options=Ink.extendObj({pageSize:void 0,endpoint:void 0,loadMode:"full",allowResetSorting:!1,visibleFields:void 0},i.data(this._rootElement)),this._options=Ink.extendObj(this._options,n||{}),this._markupMode="undefined"==typeof this._options.endpoint,this._options.visibleFields&&(this._options.visibleFields=this._options.visibleFields.split(",")),this._handlers={click:Ink.bindEvent(this._onClick,this)},this._originalFields=[],this._sortableFields={},this._originalData=this._data=[],this._headers=[],this._pagination=null,this._totalRows=0,this._init()};return l.prototype={_init:function(){if(this._markupMode){if(this._setHeadersHandlers(),a.each(o.select("tbody tr",this._rootElement),Ink.bind(function(e){this._data.push(e)},this)),this._originalData=this._data.slice(0),this._totalRows=this._data.length,"pageSize"in this._options&&"undefined"!=typeof this._options.pageSize){for(this._pagination=this._rootElement.nextSibling;1!==this._pagination.nodeType;)this._pagination=this._pagination.nextSibling;if("nav"!==this._pagination.nodeName.toLowerCase())throw"[Ink.UI.Table] :: Missing the pagination markup or is mis-positioned";var e=Ink.getModule("Ink.UI.Pagination",1);this._pagination=new e(this._pagination,{size:Math.ceil(this._totalRows/this._options.pageSize),onChange:Ink.bind(function(e){this._paginate(e._current+1)},this)}),this._paginate(1)}}else this._getData(this._options.endpoint,!0)},_onClick:function(e){var r,l,u=n.element(e),c=i.data(u),d="pageSize"in this._options&&"undefined"!=typeof this._options.pageSize;if("th"===u.nodeName.toLowerCase()&&"sortable"in c&&"true"===c.sortable.toString()){if(n.stop(e),r=-1,a.inArray(u,this._headers))for(l=0;l<this._headers.length;l++)if(this._headers[l]===u){r=l;break}if(!this._markupMode&&d){for(var f in this._sortableFields)f!=="col_"+r&&(this._sortableFields[f]="none",this._headers[f.replace("col_","")].innerHTML=s.stripTags(this._headers[f.replace("col_","")].innerHTML));"asc"===this._sortableFields["col_"+r]?(this._sortableFields["col_"+r]="desc",this._headers[r].innerHTML=s.stripTags(this._headers[r].innerHTML)+'<i class="icon-caret-down"></i>'):(this._sortableFields["col_"+r]="asc",this._headers[r].innerHTML=s.stripTags(this._headers[r].innerHTML)+'<i class="icon-caret-up"></i>'),this._pagination.setCurrent(this._pagination._current)}else{if(-1===r)return;if("desc"===this._sortableFields["col_"+r]&&this._options.allowResetSorting&&"true"===this._options.allowResetSorting.toString())this._headers[r].innerHTML=s.stripTags(this._headers[r].innerHTML),this._sortableFields["col_"+r]="none",this._data=this._originalData.slice(0);else{for(var f in this._sortableFields)f!=="col_"+r&&(this._sortableFields[f]="none",this._headers[f.replace("col_","")].innerHTML=s.stripTags(this._headers[f.replace("col_","")].innerHTML));this._sort(r),"asc"===this._sortableFields["col_"+r]?(this._data.reverse(),this._sortableFields["col_"+r]="desc",this._headers[r].innerHTML=s.stripTags(this._headers[r].innerHTML)+'<i class="icon-caret-down"></i>'):(this._sortableFields["col_"+r]="asc",this._headers[r].innerHTML=s.stripTags(this._headers[r].innerHTML)+'<i class="icon-caret-up"></i>')}var h=o.select("tbody",this._rootElement)[0];t.cleanChildren(h),a.each(this._data,function(e){h.appendChild(e)}),this._pagination.setCurrent(0),this._paginate(1)}}},_paginate:function(e){a.each(this._data,Ink.bind(function(t,n){n>=(e-1)*parseInt(this._options.pageSize,10)&&n<(e-1)*parseInt(this._options.pageSize,10)+parseInt(this._options.pageSize,10)?r.removeClassName(t,"hide-all"):r.addClassName(t,"hide-all")},this))},_sort:function(e){this._data.sort(Ink.bind(function(t,n){var r=i.textContent(o.select("td",t)[e]),a=i.textContent(o.select("td",n)[e]),s=new RegExp(/\d/g);return!isNaN(r)&&s.test(r)?r=parseInt(r,10):isNaN(r)||(r=parseFloat(r)),!isNaN(a)&&s.test(a)?a=parseInt(a,10):isNaN(a)||(a=parseFloat(a)),r===a?0:r>a?1:-1},this))},_setHeaders:function(e,t){var n,r,a,s,l;if(0===(a=o.select("thead",this._rootElement)).length){a=this._rootElement.createTHead(),s=a.insertRow(0);for(n in e)if(e.hasOwnProperty(n)){if(this._options.visibleFields&&-1===this._options.visibleFields.indexOf(n))continue;l=document.createElement("th"),r=e[n],"sortable"in r&&"true"===r.sortable.toString()&&l.setAttribute("data-sortable","true"),"label"in r&&i.setTextContent(l,r.label),this._originalFields.push(n),s.appendChild(l)}}else{var u=t[0];for(n in u)if(u.hasOwnProperty(n)){if(this._options.visibleFields&&-1===this._options.visibleFields.indexOf(n))continue;this._originalFields.push(n)}}},_setHeadersHandlers:function(){var e=o.select("thead",this._rootElement);e.length&&(n.observe(e[0],"click",this._handlers.click),this._headers=o.select("thead tr th",this._rootElement),a.each(this._headers,Ink.bind(function(e,t){var n=i.data(e);"sortable"in n&&"true"===n.sortable.toString()&&(this._sortableFields["col_"+t]="none")},this)))},_setData:function(e){var t,n,r,i,a,s;n=o.select("tbody",this._rootElement),0===n.length?(n=document.createElement("tbody"),this._rootElement.appendChild(n)):(n=n[0],n.innerHTML=""),this._data=[];for(a in e)if(e.hasOwnProperty(a)){r=document.createElement("tr"),n.appendChild(r),s=0;for(t in e[a])if(e[a].hasOwnProperty(t)){if(this._options.visibleFields&&-1===this._options.visibleFields.indexOf(t))continue;i=r.insertCell(s++),i.innerHTML=e[a][t]}this._data.push(r)}this._originalData=this._data.slice(0)},setEndpoint:function(e,t){this._markupMode||(this._options.endpoint=e,this._pagination.setCurrent(t?parseInt(t,10):0))},_setPagination:function(){if("pageSize"in this._options&&"undefined"!=typeof this._options.pageSize,"pageSize"in this._options&&"undefined"!=typeof this._options.pageSize&&!this._pagination){this._pagination=document.createElement("nav"),this._pagination.className="ink-navigation",this._rootElement.parentNode.insertBefore(this._pagination,this._rootElement.nextSibling),this._pagination.appendChild(document.createElement("ul")).className="pagination";var e=Ink.getModule("Ink.UI.Pagination",1);this._pagination=new e(this._pagination,{size:Math.ceil(this._totalRows/this._options.pageSize),onChange:Ink.bind(function(){this._getData(this._options.endpoint)},this)})}},_getData:function(e){Ink.requireModules(["Ink.Util.Url_1"],Ink.bind(function(t){var n=t.parseUrl(e),r="pageSize"in this._options&&"undefined"!=typeof this._options.pageSize,i=this._pagination?this._pagination._current+1:1;if(n.query=n.query?n.query.split("&"):[],r){n.query.push("rows_per_page="+this._options.pageSize),n.query.push("page="+i);for(var o in this._sortableFields)if("none"!==this._sortableFields[o]){n.query.push("sortField="+this._originalFields[parseInt(o.replace("col_",""),10)]),n.query.push("sortOrder="+this._sortableFields[o]);break}this._getDataViaAjax(e+"?"+n.query.join("&"))}else this._getDataViaAjax(e)},this))},_getDataViaAjax:function(t){var n="pageSize"in this._options&&"undefined"!=typeof this._options.pageSize;new e(t,{method:"GET",contentType:"application/json",sanitizeJSON:!0,onSuccess:Ink.bind(function(e){if(200===e.status){var t=JSON.parse(e.responseText);0===this._headers.length&&(this._setHeaders(t.headers,t.rows),this._setHeadersHandlers()),this._setData(t.rows),n?this._totalRows&&parseInt(t.totalRows,10)!==parseInt(this._totalRows,10)?(this._totalRows=t.totalRows,this._pagination.setSize(Math.ceil(this._totalRows/this._options.pageSize))):this._totalRows=t.totalRows:this._totalRows&&t.rows.length!==parseInt(this._totalRows,10)?(this._totalRows=t.rows.length,this._pagination.setSize(Math.ceil(this._totalRows/this._options.pageSize))):this._totalRows=t.rows.length,this._setPagination()}},this)})}},l});
Ink.createModule("Ink.UI.Tabs","1",["Ink.UI.Common_1","Ink.Dom.Event_1","Ink.Dom.Css_1","Ink.Dom.Element_1","Ink.Dom.Selector_1","Ink.Util.Array_1"],function(e,t,n,r,i,o){"use strict";var a=function(t,n){if(e.isDOMElement(t))this._element=t;else{if(t=i.select(t),0===t.length)throw new TypeError("1st argument must either be a DOM Element or a selector expression!");this._element=t[0]}this._options=Ink.extendObj({preventUrlChange:!1,active:void 0,disabled:[],onBeforeChange:void 0,onChange:void 0,triggerEventsOnLoad:!0},n||{},r.data(t)),this._handlers={tabClicked:Ink.bindEvent(this._onTabClicked,this),disabledTabClicked:Ink.bindEvent(this._onDisabledTabClicked,this),resize:Ink.bindEvent(this._onResize,this)},this._init()};return a.prototype={_init:function(){this._menu=i.select(".tabs-nav",this._element)[0],this._menuTabs=this._getChildElements(this._menu),this._contentTabs=i.select(".tabs-content",this._element),this._initializeDom(),this._observe(),this._setFirstActive(),this._changeTab(this._activeMenuLink,this._options.triggerEventsOnLoad),this._handlers.resize(),e.registerInstance(this,this._element,"tabs")},_initializeDom:function(){for(var e=0;e<this._contentTabs.length;e++)n.hide(this._contentTabs[e])},_observe:function(){o.each(this._menuTabs,Ink.bind(function(e){var t=i.select("a",e)[0];o.inArray(t.getAttribute("href"),this._options.disabled)?this.disable(t):this.enable(t)},this)),t.observe(window,"resize",this._handlers.resize)},_setFirstActive:function(){var e=window.location.hash;this._activeContentTab=i.select(e,this._element)[0]||i.select(this._hashify(this._options.active),this._element)[0]||i.select(".tabs-content",this._element)[0],this._activeMenuLink=this._findLinkByHref(this._activeContentTab.getAttribute("id")),this._activeMenuTab=this._activeMenuLink.parentNode},_changeTab:function(e,t){t&&"undefined"!=typeof this._options.onBeforeChange&&this._options.onBeforeChange(this);var r=e.getAttribute("href");n.removeClassName(this._activeMenuTab,"active"),n.removeClassName(this._activeContentTab,"active"),n.addClassName(this._activeContentTab,"hide-all"),this._activeMenuLink=e,this._activeMenuTab=this._activeMenuLink.parentNode,this._activeContentTab=i.select(r.substr(r.indexOf("#")),this._element)[0],n.addClassName(this._activeMenuTab,"active"),n.addClassName(this._activeContentTab,"active"),n.removeClassName(this._activeContentTab,"hide-all"),n.show(this._activeContentTab),t&&"undefined"!=typeof this._options.onChange&&this._options.onChange(this)},_onTabClicked:function(e){t.stop(e);var n=t.findElement(e,"A");"a"===n.nodeName.toLowerCase()&&("true"!==this._options.preventUrlChange.toString()&&(window.location.hash=n.getAttribute("href").substr(n.getAttribute("href").indexOf("#"))),n!==this._activeMenuLink&&this.changeTab(n))},_onDisabledTabClicked:function(e){t.stop(e)},_onResize:function(){var t=e.currentLayout();t!==this._lastLayout&&(t===e.Layouts.SMALL||t===e.Layouts.MEDIUM?(n.removeClassName(this._menu,"menu"),n.removeClassName(this._menu,"horizontal")):(n.addClassName(this._menu,"menu"),n.addClassName(this._menu,"horizontal")),this._lastLayout=t)},_hashify:function(e){return e?0===e.indexOf("#")?e:"#"+e:""},_findLinkByHref:function(e){e=this._hashify(e);var t;return o.each(this._menuTabs,Ink.bind(function(n){var r=i.select("a",n)[0];-1!==r.getAttribute("href").indexOf("#")&&r.getAttribute("href").substr(r.getAttribute("href").indexOf("#"))===e&&(t=r)},this)),t},_getChildElements:function(e){for(var t=[],n=e.children,r=0;r<n.length;r++)1===n[r].nodeType&&t.push(n[r]);return t},changeTab:function(e){var t=1===e.nodeType?e:this._findLinkByHref(this._hashify(e));t&&!n.hasClassName(t,"ink-disabled")&&this._changeTab(t,!0)},disable:function(e){var r=1===e.nodeType?e:this._findLinkByHref(this._hashify(e));r&&(t.stopObserving(r,"click",this._handlers.tabClicked),t.observe(r,"click",this._handlers.disabledTabClicked),n.addClassName(r,"ink-disabled"))},enable:function(e){var r=1===e.nodeType?e:this._findLinkByHref(this._hashify(e));r&&(t.stopObserving(r,"click",this._handlers.disabledTabClicked),t.observe(r,"click",this._handlers.tabClicked),n.removeClassName(r,"ink-disabled"))},activeTab:function(){return this._activeContentTab.getAttribute("id")},activeMenuTab:function(){return this._activeMenuTab},activeMenuLink:function(){return this._activeMenuLink},activeContentTab:function(){return this._activeContentTab},destroy:e.destroyComponent},a});
Ink.createModule("Ink.UI.TagField","1",["Ink.Dom.Element_1","Ink.Dom.Event_1","Ink.Dom.Css_1","Ink.Dom.Browser_1","Ink.UI.Droppable_1","Ink.Util.Array_1","Ink.Dom.Selector_1"],function(e,t,n,i,r,o){function s(t,n){var i=document.createElement(t);for(var r in n)n.hasOwnProperty(r)&&(r in e?e[r](i,n[r]):"insertBottom"===r?n[r].appendChild(i):"className"===r||"class"===r?i.className=n.className||n["class"]:i.setAttribute(r,n[r]));return i}function a(e,t){this.init(e,t)}var l=Ink.getModule("Ink.UI.Common_1")||Ink.getModule("Ink.UI.Aux_1"),u=function(e){return!!e};return a.prototype={init:function(i,r){i=this._element=l.elOrSelector(i);var a=this._options=Ink.extendObj({tags:[],tagQuery:null,tagQueryAsync:null,maxTags:-1,allowRepeated:!1,outSeparator:",",separator:/[,; ]+/g,autoSplit:!0},r||{},e.data(i));"string"==typeof a.tags&&(a.tags=this._readInput(a.tags)),n.addClassName(this._element,"hide-all"),this._viewElm=s("div",{className:"ink-tagfield",insertAfter:this._element}),this._input=s("input",{type:"text",className:"new-tag-input",insertBottom:this._viewElm});var u=[].concat(a.tags,this._tagsFromMarkup(this._element));this._tags=[],o.each(u,Ink.bindMethod(this,"_addTag")),t.observe(this._input,"keyup",Ink.bindEvent(this._onKeyUp,this)),t.observe(this._input,"change",Ink.bindEvent(this._onKeyUp,this)),t.observe(this._input,"keydown",Ink.bindEvent(this._onKeyDown,this)),t.observe(this._input,"blur",Ink.bindEvent(this._onBlur,this)),t.observe(this._viewElm,"click",Ink.bindEvent(this._refocus,this))},destroy:function(){e.remove(this._viewElm),n.removeClassName(this._element,"hide-all")},_tagsFromMarkup:function(t){var n=t.tagName.toLowerCase();if("input"===n)return this._readInput(t.value);if("select"===n)return o.map(t.getElementsByTagName("option"),function(t){return e.textContent(t)});throw new Error("Cannot read tags from a "+n+" tag. Unknown tag")},_tagsToMarkup:function(t,n){var i=n.tagName.toLowerCase();if("input"===i)this._options.separator&&(n.value=t.join(this._options.outSeparator));else{if("select"!==i)throw new Error("TagField: Cannot read tags from a "+i+" tag. Unknown tag");n.innerHTML="",o.each(t,function(t){var i=s("option",{selected:"selected"});e.setTextContent(i,t),n.appendChild(i)})}},_addTag:function(e){if(!(-1!==this._options.maxTags&&this._tags.length>this._options.maxTags)){if(!this._options.allowRepeated&&o.inArray(e,this._tags,e)||!e)return!1;var n=s("span",{className:"ink-tag",setTextContent:e+" "}),i=s("i",{className:"remove icon-remove",insertBottom:n});t.observe(i,"click",Ink.bindEvent(this._removeTag,this,null));var r=document.createTextNode(" ");this._tags.push(e),this._viewElm.insertBefore(n,this._input),this._viewElm.insertBefore(r,this._input),this._tagsToMarkup(this._tags,this._element)}},_readInput:function(e){return this._options.separator?o.filter(e.split(this._options.separator),u):[e]},_onKeyUp:function(){if(this._options.autoSplit){var e=this._input.value.split(this._options.separator);if(!(e.length<=1)){var t=e[e.length-1];e=e.splice(0,e.length-1),e=o.filter(e,u),o.each(e,Ink.bind(this._addTag,this)),this._input.value=t}}},_onKeyDown:function(e){return 13===e.which?this._onEnterKeyDown(e):27===e.which?this._onBackspaceKeyDown():(this._removeConfirm&&this._unsetRemovingVisual(this._tags.length-1),void 0)},_onBackspaceKeyDown:function(){this._input.value||(this._removeConfirm?(this._unsetRemovingVisual(this._tags.length-1),this._removeTag(this._tags.length-1),this._removeConfirm=null):this._setRemovingVisual(this._tags.length-1))},_onEnterKeyDown:function(e){var n=this._input.value;n&&(this._addTag(n),this._input.value=""),t.stopDefault(e)},_onBlur:function(){this._addTag(this._input.value),this._input.value=""},_setRemovingVisual:function(e){var i=this._viewElm.children[e];n.addClassName(i,"tag-deleting"),this._removeRemovingVisualTimeout=setTimeout(Ink.bindMethod(this,"_unsetRemovingVisual",e),4e3),t.observe(this._input,"blur",Ink.bindMethod(this,"_unsetRemovingVisual",e)),this._removeConfirm=!0},_unsetRemovingVisual:function(e){var t=this._viewElm.children[e];t&&(n.removeClassName(t,"tag-deleting"),clearTimeout(this._removeRemovingVisualTimeout)),this._removeConfirm=null},_removeTag:function(n){var i;if("object"==typeof n){var r=t.element(n).parentNode;i=e.parentIndexOf(this._viewElm,r)}else"number"==typeof n&&(i=n);this._tags=o.remove(this._tags,i,1),e.remove(this._viewElm.children[i]),this._tagsToMarkup(this._tags,this._element)},_refocus:function(e){return this._input.focus(),t.stop(e),!1}},a});
...
Ink.createModule("Ink.UI.SortableList","1",["Ink.UI.Common_1","Ink.Dom.Event_1","Ink.Dom.Css_1","Ink.Dom.Element_1","Ink.Dom.Selector_1","Ink.Util.Array_1"],function(e,t,n,i,o,s){"use strict";var r=function(t,n){if(this._element=e.elOrSelector(t,"1st argument"),!e.isDOMElement(t)&&"string"!=typeof t)throw"[Ink.UI.SortableList] :: Invalid selector";if("string"==typeof t){if(this._element=Ink.Dom.Selector.select(t),this._element.length<1)throw"[Ink.UI.SortableList] :: Selector has returned no elements";this._element=this._element[0]}else this._element=t;if(this._options=Ink.extendObj({dragObject:"li"},Ink.Dom.Element.data(this._element)),this._options=Ink.extendObj(this._options,n||{}),this._handlers={down:Ink.bindEvent(this._onDown,this),move:Ink.bindEvent(this._onMove,this),up:Ink.bindEvent(this._onUp,this)},this._model=[],this._index=void 0,this._isMoving=!1,this._options.model instanceof Array)this._model=this._options.model,this._createdFrom="JSON";else{if("ul"!==this._element.nodeName.toLowerCase())throw new TypeError("You must pass a selector expression/DOM element as 1st option or provide a model on 2nd argument!");this._createdFrom="DOM"}if(this._dragTriggers=o.select(this._options.dragObject,this._element),!this._dragTriggers)throw"[Ink.UI.SortableList] :: Drag object not found";this._init()};return r.prototype={_init:function(){"DOM"===this._createdFrom&&(this._extractModelFromDOM(),this._createdFrom="JSON");var n="ontouchstart"in document.documentElement;this._down=n?"touchstart":"mousedown",this._move=n?"touchmove":"mousemove",this._up=n?"touchend":"mouseup";var i=document.body;t.observe(i,this._move,this._handlers.move),t.observe(i,this._up,this._handlers.up),this._observe(),e.registerInstance(this,this._element,"sortableList")},_observe:function(){t.observe(this._element,this._down,this._handlers.down)},_extractModelFromDOM:function(){this._model=[];var e=this,t=o.select("> li",this._element);s.each(t,function(t){var n=t.innerHTML;e._model.push(n)})},_generateMarkup:function(){var e=document.createElement("ul");e.className="unstyled ink-sortable-list";var t=this;return s.each(this._model,function(n,i){var o=document.createElement("li");i===t._index&&(o.className="drag"),o.innerHTML=[n].join(""),e.appendChild(o)}),e},_getY:function(e){return 0===e.type.indexOf("touch")?e.changedTouches[0].pageY:"number"==typeof e.pageY?e.pageY:e.clientY},_refresh:function(t){var n=this._generateMarkup();this._element.parentNode.replaceChild(n,this._element),this._element=n,e.restoreIdAndClasses(this._element,this),this._dragTriggers=o.select(this._options.dragObject,this._element),t||this._observe()},_onDown:function(n){if(!this._isMoving){var i=t.element(n);if(!s.inArray(i,this._dragTriggers)){for(;!s.inArray(i,this._dragTriggers)&&"body"!==i.nodeName.toLowerCase();)i=i.parentNode;if("body"===i.nodeName.toLowerCase())return}t.stop(n);var o;if("li"!==i.nodeName.toLowerCase())for(;"li"!==i.nodeName.toLowerCase()&&"body"!==i.nodeName.toLowerCase();)i=i.parentNode;return o=i,this._index=e.childIndex(o),this._height=o.offsetHeight,this._startY=this._getY(n),this._isMoving=!0,document.body.style.cursor="move",this._refresh(!1),!1}},_onMove:function(e){if(this._isMoving){t.stop(e);var n=this._getY(e),i=n-this._startY,o=i>0?1:-1,s=o*Math.floor(Math.abs(i)/this._height);if(0!==s&&(s/=Math.abs(s),!(-1===s&&0===this._index||1===s&&this._index===this._model.length-1))){var r=s>0?this._index:this._index+s,a=0>s?this._index:this._index+s;this._model.splice(r,2,this._model[a],this._model[r]),this._index+=s,this._startY=n,this._refresh(!1)}}},_onUp:function(e){this._isMoving&&(t.stop(e),this._index=void 0,this._isMoving=!1,document.body.style.cursor="",this._refresh())},getModel:function(){return this._model.slice()},destroy:e.destroyComponent},r});