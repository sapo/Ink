...
Ink.createModule("Ink.UI.TreeView","1",["Ink.UI.Common_1","Ink.Dom.Event_1","Ink.Dom.Css_1","Ink.Dom.Element_1","Ink.Dom.Selector_1","Ink.Util.Array_1"],function(e,t,n,r,i,o){"use strict";var a=function(t,n){if(!e.isDOMElement(t)&&"string"!=typeof t)throw"[Ink.UI.TreeView] :: Invalid selector";if("string"==typeof t){if(this._element=i.select(t),this._element.length<1)throw"[Ink.UI.TreeView] :: Selector has returned no elements";this._element=this._element[0]}else this._element=t;this._options=Ink.extendObj({node:"li",child:"ul",parentClass:"parent",openClass:"icon-minus-sign",closedClass:"icon-plus-sign",hideClass:"hide-all",iconTag:"i"},r.data(this._element)),this._options=Ink.extendObj(this._options,n||{}),this._init()};return a.prototype={_init:function(){this._handlers={click:Ink.bindEvent(this._onClick,this)},t.observe(this._element,"click",this._handlers.click);var e,n,a=i.select(this._options.node,this._element),s=!1;o.each(a,Ink.bind(function(t){n=i.select(this._options.child,t),n.length>0&&(this._addClassNames(t,this._options.parentClass),s="true"===r.data(t).open,e=Ink.Dom.Selector.select("> "+this._options.iconTag,t)[0],e||(e=Ink.Dom.Element.create("i"),t.insertBefore(e,t.children[0])),s?this._addClassNames(e,this._options.openClass):(this._addClassNames(e,this._options.closedClass),t.setAttribute("data-open",!1),o.each(n,Ink.bind(function(e){this._addClassNames(e,this._options.hideClass)},this))))},this))},_addClassNames:function(e,t){t=(""+t).split(/[ ,]+/),o.each(t,function(t){n.addClassName(e,t)})},_toggleClassNames:function(e,t){t=(""+t).split(/[ ,]+/),o.each(t,function(t){n.hasClassName(e,t)?n.removeClassName(e,t):n.addClassName(e,t)})},_onClick:function(e){var n=t.element(e);if(n=r.findUpwardsBySelector(n,this._options.node),n!==!1){var o,a,s=i.select(this._options.child,n);s.length>0&&(t.stop(e),s=s[0],this._toggleClassNames(s,this._options.hideClass),o="true"===r.data(n).open,a=n.children[0],o?n.setAttribute("data-open",!1):n.setAttribute("data-open",!0),this._toggleClassNames(a,this._options.openClass),this._toggleClassNames(a,this._options.closedClass))}}},a});
