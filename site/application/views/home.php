<div class="ink-hero">
	<img src="<?php echo specific_url('imgs') ?>logo_home.png" alt="Logo Home" class="ink-l100 logo_hp">
	<div class="glow"><img src="<?php echo specific_url('imgs') ?>glow1.png" class="ink-l100 logo_hp" alt="Glow1"></div>
</div>
		...
		<div class="ink-row ink-vspace">
			...
			<div class="ink-l33">
				<div class="ink-gutter">
					...
					<p>
						Customize your basic layout - site width, gutters, colors and much more
					</p>
				</div>
			</div>
			<div class="ink-l33">
