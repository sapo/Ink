        ...
        <div class="ink-row ink-vspace">
            ...
            <div class="ink-l70">
                <div class="ink-gutter">
                    <div class="ink-row box">
                        <div class="ink-gutter">
                            <div class="ink-tabs">
                                <nav class="ink-navigation">
                                    <ul class="ink-tabs-nav menu horizontal">
                                        ...
                                        <li><a href="#ui_tabs_more_stuff">More stuff</a></li>
                                    </ul>
                                </nav>
                            ...
                            <div id="ui_tabs_more_stuff" class="ink-tabs-container">
                                <h4>More Stuff</h4>
                                <p>
                                    Arnold ipsum. Well then God shouldn't have cloned my dog. I'm a cybernetic
                                    organizm. Living tissue over endoskeleton. You're not going to have your
                ...
                <div class="ink-row">
                    ...
                    <pre id="tabs_sourcecode" style="display:none" class="prettyprint linenums ink-vspace"><?php echo(htmlentities( $js )); ?></pre>
                </div>
            </div>
        </div>
    </div>
