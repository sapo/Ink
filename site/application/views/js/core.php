...
<div class="ink-container">
	<div class="ink-section">
		<p>
			Ink was built from the ground up to be easy to use and easy on the eyes, but some of the bricks were borrowed from one of our other premiere web frameworks, LibSAPO.js. 
			Listed here are a few key classes and methods that you can take advantage of when building your applications.
		</p>
		...
		<ul>
			...
			<li><a href="http://js.sapo.pt/SAPO/Dom/Element/0.">http://js.sapo.pt/SAPO/Dom/Element/0.1/</a></li>
			...
			<li><a href="http://js.sapo.pt/SAPO/Utility/Array/0.">http://js.sapo.pt/SAPO/Utility/Array/0.1/</a></li>
			<li><a href="http://js.sapo.pt/SAPO/Utility/Swipe/0.">http://js.sapo.pt/SAPO/Utility/Swipe/0.1/</a></li>
...
<pre class="prettyprint linenums">SAPO.require(
    ...
    function(){
		...
		<p>
			<em>namespace</em> - Sometimes it's convenient to extend the framework to fit your needs, maybe you want to add a new component, or maybe you want to create a new collection of classes. 
			SAPO.namespace will return the object you asked for or create a new one if none was found.
		</p>
