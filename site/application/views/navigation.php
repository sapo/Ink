...
<div class="ink-container">
	...
	<div class="ink-section">
		<div class="ink-vspace">
			...
			<p>
				To build a horizontal menu with ink start with a block-level element and use the <code>ink-navigation</code> class. 
				We prefer to use a <code><?php echo htmlentities('<nav>') ?></code> tag to wrap our navigation items, but a <code><?php echo htmlentities('<div>') ?></code> will do just fine.
			</p>
			<p>
				The menu itself is built with a unordered list with the <code>menu</code> and <code>horizontal</code> classes. 
				Adding color is as simple as adding a class to the menu list element. Available classes are <code>grey</code>, <code>green</code>, <code>blue</code>, <code>red</code>, <code>orange</code> and <code>black</code>!
			</p>
		</div>
...
<?php echo(htmlentities('<footer>
   <ul class="ink-footer-nav">
	...
	<div class="ink-section">
		<h3>Pagination</h3>
		<p>Paginations can be created by adding the <code>pagination</code> class to a list inside an <code>ink-navigation</code> parent. The <code>.active</code> and <code>.disabled</code> classes are available to diferentiate the current page and disabled links.</p>
