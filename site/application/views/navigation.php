	...
	<ul class="pagination">
	 ...
	 <div class="ink-section">
	 	<a name="pills"></a>
		  ...
		  <p>
				Pills can be created by adding the <code>pagination</code> class to a list inside an <code>ink-navigation</code> parent. The <code>.active</code> and <code>.disabled</code> classes are available.
		  </p>
		  <h4>
				example
		  </h4>
