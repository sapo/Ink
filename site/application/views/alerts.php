	...
	<div class="ink-section">
		<div class="ink-l25">
			<div class="ink-space">
				...
				<p>
					Os Avisos Básicos são úteis para formulários ou notificações simples.
				</p>
				<br>
				<p>
					Para usar o estilo dos avisos básicos basta usar a class
					<mark>.alert-msg</mark>
					, podendo esta ser acompanhada das classes:
				</p>
				<ul class="unstyled">
					<li>
						<mark>.error</mark>
		...
		<div class="ink-l75">
			<div class="ink-space">
				<div class="alert-msg">
					...
					<p> <b>Aviso:</b>
						Aqui fica o texto da notificação
					</p>
				</div>
	...
	<div class="ink-section">
		<div class="ink-l25">
			<div class="ink-space">
				...
				<p>
					Os Avisos Básicos são úteis para formulários com explicação detalhada de erros ou erros onde será necessário acção.
				</p>
				<ul class="unstyled">
					<li>
						<mark>.error</mark>
		...
		<div class="ink-l75">
			<div class="ink-space">
				...
				<div class="block-alert-msg success">
					...
					<p>
						O seu formulário foi submetido e aguarda revisão.
						<br>No entanto pode:</p>
					<p>
						<a href="#" class="ink-button">Voltar ao site</a>
						<a href="#"  class="ink-button">Sair</a>
					</p>
				</div>
